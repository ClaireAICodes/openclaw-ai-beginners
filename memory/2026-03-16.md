...
## Runtime
Runtime: agent=main | host=ip-172-31-36-83 | repo=/home/node/.openclaw/workspace | os=Linux 6.14.0-1018-aws (x64) | node=v25.6.1 | model=openrouter/arcee-ai/trinity-large-preview:free | default_model=openrouter/openrouter/hunter-alpha | shell=bash | channel=telegram | capabilities=inlineButtons | thinking=off
